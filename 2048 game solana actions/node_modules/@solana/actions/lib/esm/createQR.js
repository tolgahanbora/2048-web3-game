 ...
 */
export function createSolanaQR(url, size = 512, background = "white", color = "black") {
    return new QRCodeStyling(createSolanaQROptions(url, size, background, color));
}
/** @ignore */
export const SolanaQRCodeStyling = QRCodeStyling;
/** @ignore */
export function createSolanaQROptions(url, size = 512, background = "white", color = "black") {
    return {
        type: "svg",
        width: size,
        height: size,
