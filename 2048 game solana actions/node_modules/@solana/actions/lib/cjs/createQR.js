...
exports.createSolanaQROptions = exports.SolanaQRCodeStyling = exports.createSolanaQR = void 0;
 ...
 */
function createSolanaQR(url, size = 512, background = "white", color = "black") {
    return new qr_code_styling_1.default(createSolanaQROptions(url, size, background, color));
}
exports.createSolanaQR = createSolanaQR;
/** @ignore */
exports.SolanaQRCodeStyling = qr_code_styling_1.default;
/** @ignore */
function createSolanaQROptions(url, size = 512, background = "white", color = "black") {
    return {
        type: "svg",
        width: size,
        height: size,
...
exports.createSolanaQROptions = createSolanaQROptions;
